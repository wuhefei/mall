...
public class OAuth2Controller {
     ...
     * Request URL: http://auth.gulimall.com/oauth2.0/weibo/success?code=dd2be4a9d04f390017dd4b366b0d3fe6
     * @param code
     * @return
     * @throws Exception
     */
    ...
    public String weibo(@RequestParam("code") String code, HttpSession session, HttpServletResponse servletResponse) throws Exception {
        ...
        map.put("client_id", "2185342896");
        map.put("client_secret", "bd2f21bff206e3e944487bd78e9db9ab");
        ...
        if (response.getStatusLine().getStatusCode() == 200) {
            ...
            if (r.getCode() == 0) {
                ...
                session.setAttribute(AuthServerConstant.LOGIN_USER, memberRespVo); //放入redis中了。
